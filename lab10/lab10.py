...
class AVLTree:
    ...
    def rebalance(t):
        ### BEGIN SOLUTION
        imbalance = AVLTree.Node.height(t.left) - AVLTree.Node.height(t.right)
        if imbalance >= 2:
            imbalance = AVLTree.Node.height(t.left.left) - AVLTree.Node.height(t.left.right)
            if imbalance < 0:
                t.left.rotate_left()
            t.rotate_right()
        elif imbalance <= -2:
            imbalance = AVLTree.Node.height(t.right.left) - AVLTree.Node.height(t.right.right)
            if imbalance > 0:
